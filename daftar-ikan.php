      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-none d-lg-flex gap-3">
              <a class="btn btn-outline-danger text-white" data-bs-toggle="modal" href="logout.php" data-bs-target="#staticBackdrop">Logout</a>
            </div>
            <div class="d-flex d-lg-none flex-column gap-3 mt-3">
              <a class="btn btn-outline-danger text-white w-100" data-bs-toggle="modal" href="logout.php" data-bs-target="#staticBackdrop">Logout</a>
            </div>
        </div>
      </div>
    </nav>
            ...
            <div class="card shadow-sm card-ikan">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 mt-3">
                  <button type="button" class="btn btn-info text-center" data-bs-toggle="modal" data-bs-target="#modal<?= $tampildata['fish_id']; ?>">
                    Detail
                  </button>
                </div>
              </div>
                  ...
                  <!-- Modal -->
         <div class="modal fade" id="modal<?= $tampildata['fish_id']; ?>" tabindex="-1" aria-labelledby="modalLabel<?= $tampildata['fish_id']; ?>" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalLabel<?= $tampildata['fish_id']; ?>">Detail Ikan</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body text-start">
                <div class="">
                  <img src="img/ikan/<?= $tampildata['gambar']; ?>" class="img-thumbnail" alt="gambar ikan">
                </div>
                <h2 class="my-3 ms-2"><?= $tampildata['fish_name']; ?></h2>
                <p class="fs-5 text-start fw-light px-2" style="text-align: justif;">
